...
export function renderWelcomeView(onStart: () => void) {
    ...
    container.innerHTML = `
        <div style="display:flex; flex-direction:column; height:100%; justify-content: space-between; padding-top: 5rem; padding-bottom: 2rem; background:white; overflow:hidden;">
            ...
            <div class="brand-wrapper" style="animation: bounceIn 0.8s cubic-bezier(0.68, -0.55, 0.27, 1.55);">
                <div class="elaz-main">
                    ...
                    <span class="l-char l-z">Z<i class="fas fa-motorcycle z-courier"></i></span>
                </div>
                <div class="market-badge">MARKET</div>
                
                <p style="color:var(--gray); margin-top:3rem; font-size:1.1rem; font-weight:700; line-height:1.5; text-align:center; max-width:280px;">
            ...
            <div style="padding: 20px;">
                <div style="display:flex; gap:12px; margin-bottom:3rem;">
                    <div style="flex:1; background:#f8fafc; padding:18px 10px; border-radius:24px; text-align:center; border:1.5px solid #f1f5f9;">
                        ...
                        <div style="font-size:0.7rem; font-weight:800;">TEZKOR</div>
                    </div>
                    <div style="flex:1; background:#f8fafc; padding:18px 10px; border-radius:24px; text-align:center; border:1.5px solid #f1f5f9;">
                        <i class="fas fa-shield-heart" style="color:var(--primary); font-size:1.4rem; margin-bottom:8px;"></i>
                        <div style="font-size:0.7rem; font-weight:800;">ISHONCHLI</div>
                    </div>
                    <div style="flex:1; background:#f8fafc; padding:18px 10px; border-radius:24px; text-align:center; border:1.5px solid #f1f5f9;">
                        <i class="fas fa-truck-fast" style="color:#ef4444; font-size:1.4rem; margin-bottom:8px;"></i>
                        <div style="font-size:0.7rem; font-weight:800;">ARZON</div>
                    </div>
                </div>

                <button class="btn btn-primary" id="btnGetStarted" style="font-size:1.2rem; width:100%; height:72px; border-radius:24px; font-weight:900; box-shadow:0 15px 30px rgba(34,197,94,0.3);">
                    BOSHLASH <i class="fas fa-arrow-right"></i>
                </button>
                <p style="text-align:center; margin-top:2rem; font-size:0.7rem; color:var(--gray); font-weight:800; opacity:0.6; letter-spacing:1px;">
                    ELAZ GROUP © 2024
                </p>
            </div>
        </div>
