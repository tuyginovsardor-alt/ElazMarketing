            ...
            <div style="padding:25px; border-radius: 40px 40px 0 0; background:white; margin-top:-35px; position:relative; z-index:10;">
                ...
                <div style="margin-top:30px; display:flex; align-items:center; justify-content:space-between; background:#f8fafc; padding:20px 25px; border-radius:24px;">
                    ...
                    <div style="display:flex; align-items:center; gap:15px;">
                        <button onclick="changeDetailQty(-${step})" style="width:44px; height:44px; border-radius:14px; background:white; border:1px solid #e2e8f0; cursor:pointer;"><i class="fas fa-minus"></i></button>
                        ...
                        <button onclick="changeDetailQty(${step})" style="width:44px; height:44px; border-radius:14px; background:var(--primary); color:white; border:none; cursor:pointer;"><i class="fas fa-plus"></i></button>
                    </div>
                </div>
    ...
    if (isAlreadyInCart && !hasChanged) {
        return `
            <button class="btn btn-primary" style="width:100%; height:65px; border-radius:22px; font-size:1.1rem; background:var(--dark);" onclick="goToCheckout()">
                RASMIYLASHTIRISHGA O'TISH <i class="fas fa-arrow-right" style="margin-left:8px;"></i>
            </button>
        `;
    } else {
        return `
