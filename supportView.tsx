        ...
        <div style="padding-bottom:50px;">
            ...
            <div class="card" style="border-radius:28px; padding:25px; border:none; background:white; box-shadow:var(--shadow-sm); margin-bottom:25px;">
                <div style="text-align:center; margin-bottom:25px;">
                    ...
                    <p style="font-size:0.8rem; color:var(--gray); margin-top:5px;">Biz bilan telegram bot orqali yoki quyidagi shaklni to'ldirish orqali bog'lanishingiz mumkin.</p>
                </div>
            ...
            <div style="background:#f8fafc; border-radius:24px; padding:20px;">
                <h4 style="font-weight:900; font-size:0.9rem; margin-bottom:12px;">Tezkor aloqa:</h4>
                <a href="https://t.me/elaz_support_bot" target="_blank" style="display:flex; align-items:center; gap:12px; text-decoration:none; color:var(--text); font-weight:700; background:white; padding:15px; border-radius:15px; border:1px solid #e2e8f0;">
                    <i class="fab fa-telegram" style="color:#0088cc; font-size:1.5rem;"></i> Telegram orqali yozish
                </a>
            </div>
        </div>
    `;
