    ...
    container.innerHTML = `
        <div style="padding-bottom:120px; animation: fadeIn 0.4s ease-out;">
                ...
                <div style="display:flex; align-items:center; gap:20px; position:relative; z-index:1;">
                    ...
                    <div style="flex:1;">
                        ...
                        <div style="margin-top:8px; display:inline-block; font-size:0.6rem; font-weight:900; background:rgba(0,0,0,0.1); padding:4px 12px; border-radius:10px; text-transform:uppercase;">
                            ${data?.role || 'USER'} ${isLinked ? '• <i class="fab fa-telegram"></i> ULANGAN' : ''}
                        </div>
                    </div>
            ...
            <div style="display:grid; grid-template-columns: 1fr 1fr; gap:15px; margin-bottom:25px;">
                ...
                <div class="card" onclick="navTo('orders')" style="padding:22px; border-radius:32px; border:1.5px solid #f1f5f9; cursor:pointer; background:white; text-align:center;">
                    <i class="fas fa-receipt" style="color:#3b82f6; margin-bottom:12px; font-size:1.4rem;"></i>
            ...
            ${!isLinked ? `
                <div onclick="connectToBot()" class="card" style="background:#eff6ff; border:1.5px solid #dbeafe; padding:20px; border-radius:30px; margin-bottom:25px; display:flex; align-items:center; gap:20px; cursor:pointer; animation: pulseLight 2s infinite;">
                    ...
                    <div style="flex:1;">
                        <div style="font-weight:900; font-size:0.95rem; color:#1e40af;">Botni ulang</div>
